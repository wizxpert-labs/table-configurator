...
<template>
    ...
    <div ref="rootEl" class="header-wrapper">
        ...
        <div class="header-title pl-1" :title="displayTitle()">
            {{ displayTitle() }}
        </div>
        ...
        >
            <div class="toolbar-buttons">
                <Button label="B" :severity="isBold ? 'primary' : undefined" :outlined="!isBold"
                        class="btn-square" :aria-pressed="isBold" :title="t('header.menu.bold')" @click="toggleBold"/>
                <div class="divider-vertical"/>
                <Button icon="pi pi-align-left" :outlined="!isAlign('left')"
                        :severity="isAlign('left') ? 'primary' : undefined" class="btn-square"
                        :title="t('header.menu.alignLeft')" @click="setAlign('left')"/>
                <Button icon="pi pi-align-center" :outlined="!isAlign('center')"
                        :severity="isAlign('center') ? 'primary' : undefined" class="btn-square"
                        :title="t('header.menu.alignCenter')" @click="setAlign('center')"/>
                <Button icon="pi pi-align-right" :outlined="!isAlign('right')"
                        :severity="isAlign('right') ? 'primary' : undefined" class="btn-square"
                        :title="t('header.menu.alignRight')" @click="setAlign('right')"/>
                <div class="divider-vertical"/>
        ...
        <Popover ref="opBg" appendTo="body" :dismissable="true" :showCloseIcon="true" class="fs-11">
            <div class="px-2 py-2 dtkit-color-grid-wrap bg-white" @click.stop>
                <div class="dtkit-color-grid mx-auto"
